...
let
  ...
  exe = pkgs.haskell.lib.justStaticExecutables (myHaskellPackages."selective-prob");

  docker = pkgs.dockerTools.buildImage {
    name = "selective-prob";
    config.Cmd = [ "${exe}/bin/selective-prob" ];
  };
in
{
  inherit shell;
  ...
  "selective-prob" = myHaskellPackages."selective-prob";
}
